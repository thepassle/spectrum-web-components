...
module.exports = {
    stories: [
        ...
        '../packages/circle-loader/stories/*.stories.js',
    ...
    refs: {
        swc: {
            ...
            url:
                'https://600a3876e870ab4ae5ec2f03--spectrum-web-components.netlify.app/storybook',
        },
    },
    rollupConfig(config) {
